...
| OI-011 | 3D Mesh Content | Viewer shows walls/openings mainly; user wants “everything” mapped | High | In Progress | 2026-08-08 | | Dense LiDAR mesh collector + colored export added; needs device QA (new scan required) |
